...
#define PIPSOLAR_SELECT(name, polling_command, value_type) \
  PIPSOLAR_VALUED_ENTITY_(PipsolarSelect, name, polling_command, value_type)
...
class Pipsolar : public uart::UARTDevice, public PollingComponent {
  ...
  PIPSOLAR_SENSOR(ac_output_rating_apparent_power, QPIRI, float)
  PIPSOLAR_SENSOR(ac_output_rating_active_power, QPIRI, float)
  ...
  PIPSOLAR_SELECT(battery_type, QPIRI, float)
  ...
  PIPSOLAR_SELECT(output_source_priority, QPIRI, float)
  PIPSOLAR_SELECT(charger_source_priority, QPIRI, float)
 ...
 protected:
  ...
  void decode_QPIRI(const char* buffer);
  void decode_QPIGS(const char* buffer);
  void decode_QMOD(const char* buffer);
  void decode_QFLAG(const char* buffer);
  void decode_QPIWS(const char* buffer);
