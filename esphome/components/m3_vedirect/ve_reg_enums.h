...
#define BITMASK_DEVICE_OFF_REASON_2(ENUM) \
  ENUM(NO_INPUT_POWER, 0x00), ENUM(PHYSICAL_POWER_SWITCH, 0x01), \
  ENUM(SOFT_POWER_SWITCH, 0x02), ENUM(REMOTE_INPUT, 0x03), ENUM(INTERNAL_REASON, 0x04), \
  ENUM(PAYGO, 0x05), ENUM(BMS_SHUTDOWN, 0x06), ENUM(ENGINE, 0x07), ENUM(INPUT_VOLTAGE, 0x08), \
  ENUM(BATTERY_TEMPERATURE, 0x09), 
