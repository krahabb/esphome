...
#define REGISTERS_COMMON(MACRO) \
  ...
  MACRO(ANY, UNKNOWN, 0x0100, PRODUCT_ID, CONSTANT) \
  MACRO(ANY, UNKNOWN, 0x0102, APP_VER, CONSTANT) \
  ...
  MACRO(MULTI_RS, NUMERIC, 0x2213, UNKNOWN_2213, READ_ONLY, int16_t, V, S_0_01, S_0_01) \
  MACRO(MULTI_RS, NUMERIC, 0x2214, UNKNOWN_2214, READ_ONLY, int16_t, NONE, S_1, S_1) \
  MACRO(MULTI_RS, NUMERIC, 0x2215, UNKNOWN_2215, READ_ONLY, int32_t, NONE, S_1, S_1) \
  MACRO(MULTI_RS, NUMERIC, 0x2216, UNKNOWN_2216, READ_ONLY, int32_t, NONE, S_1, S_1) \
  MACRO(MULTI_RS, NUMERIC, 0x2250, UNKNOWN_2250, READ_ONLY, int16_t, NONE, S_1, S_1) \
  MACRO(MULTI_RS, NUMERIC, 0x2251, UNKNOWN_2251, READ_ONLY, int16_t, NONE, S_1, S_1) \
  MACRO(MULTI_RS, NUMERIC, 0xD3A1, UNKNOWN_D3A1, READ_ONLY, int32_t, NONE, S_1, S_1) \
