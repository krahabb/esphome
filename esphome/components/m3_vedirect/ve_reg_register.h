...
#define REGISTERS_COMMON(MACRO) \
  ...
  MACRO(MULTI_RS, NUMERIC, 0x2214, UNKNOWN_2214, READ_ONLY, int16_t, UNKNOWN, S_1, S_1) \
  MACRO(MULTI_RS, NUMERIC, 0x2215, UNKNOWN_2215, READ_ONLY, int32_t, UNKNOWN, S_1, S_1) \
  ...
  MACRO(MULTI_RS, NUMERIC, 0xD3A1, UNKNOWN_D3A1, READ_ONLY, int32_t, UNKNOWN, S_1, S_1) \
