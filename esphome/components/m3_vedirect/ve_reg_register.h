...
#define REGISTERS_COMMON(MACRO) \
  MACRO(ANY, UNKNOWN, REG_DEF::REGISTER_UNDEFINED, UNDEFINED, READ_ONLY) \
  ...
  MACRO(INV, NUMERIC, 0x2211, VOLTAGE_RANGE_MIN, READ, uint16_t, V, S_0_01, S_0_01) \
  MACRO(INV, NUMERIC, 0x2212, VOLTAGE_RANGE_MAX, READ, uint16_t, V, S_0_01, S_0_01) \
